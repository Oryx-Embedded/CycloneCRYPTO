...
//Streebog hash support?
#if (STREEBOG256_SUPPORT == ENABLED || STREEBOG512_SUPPORT == ENABLED)
...
#elif (STREEBOG512_SUPPORT == ENABLED)
   #define MAX_HASH_BLOCK_SIZE STREEBOG_BLOCK_SIZE
#elif (STREEBOG256_SUPPORT == ENABLED)
   #define MAX_HASH_BLOCK_SIZE STREEBOG_BLOCK_SIZE
...
#elif (STREEBOG512_SUPPORT == ENABLED)
   #define MAX_HASH_DIGEST_SIZE STREEBOG512_DIGEST_SIZE
#elif (BLAKE2B384_SUPPORT == ENABLED)
...
#elif (STREEBOG256_SUPPORT == ENABLED)
#define MAX_HASH_DIGEST_SIZE STREEBOG256_DIGEST_SIZE
#elif (SM3_SUPPORT == ENABLED)
...
#endif
#if (STREEBOG512_SUPPORT == ENABLED || STREEBOG256_SUPPORT == ENABLED)
   StreebogContext streebogContext;
#endif
} HashContext;
