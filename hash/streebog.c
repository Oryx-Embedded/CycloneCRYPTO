...
const HashAlgo streebog256HashAlgo =
{
   "Streebog-256",
   STREEBOG256_OID,
   sizeof(STREEBOG256_OID),
   sizeof(StreebogContext),
   STREEBOG_BLOCK_SIZE,
   STREEBOG256_DIGEST_SIZE,
   STREEBOG256_MIN_PAD_SIZE,
   TRUE,
   (HashAlgoCompute)streebog256Compute,
   (HashAlgoInit)streebog256Init,
   (HashAlgoUpdate)streebogUpdate,
   (HashAlgoFinal)streebogFinal,
   NULL
};
#endif
...
const HashAlgo streebog512HashAlgo =
{
   "Streebog-512",
   STREEBOG512_OID,
   sizeof(STREEBOG512_OID),
   sizeof(StreebogContext),
   STREEBOG_BLOCK_SIZE,
   STREEBOG512_DIGEST_SIZE,
   STREEBOG512_MIN_PAD_SIZE,
   TRUE,
   (HashAlgoCompute)streebog512Compute,
   (HashAlgoInit)streebog512Init,
   (HashAlgoUpdate)streebogUpdate,
   (HashAlgoFinal)streebogFinal,
   NULL
};
...
static const struct streebog_uint512 buffer512 = { {
	htole64(0x200), 0, 0, 0, 0, 0, 0, 0
} };


static const struct streebog_uint512 C[12] = {
	{ {
		 htole64(0xdd806559f2a64507ULL),
		 htole64(0x05767436cc744d23ULL),
		 htole64(0xa2422a08a460d315ULL),
		 htole64(0x4b7ce09192676901ULL),
		 htole64(0x714eb88d7585c4fcULL),
		 htole64(0x2f6a76432e45d016ULL),
		 htole64(0xebcb2f81c0657c1fULL),
		 htole64(0xb1085bda1ecadae9ULL)
	 } },
	{ {
		 htole64(0xe679047021b19bb7ULL),
		 htole64(0x55dda21bd7cbcd56ULL),
		 htole64(0x5cb561c2db0aa7caULL),
		 htole64(0x9ab5176b12d69958ULL),
		 htole64(0x61d55e0f16b50131ULL),
		 htole64(0xf3feea720a232b98ULL),
		 htole64(0x4fe39d460f70b5d7ULL),
		 htole64(0x6fa3b58aa99d2f1aULL)
	 } },
	{ {
		 htole64(0x991e96f50aba0ab2ULL),
		 htole64(0xc2b6f443867adb31ULL),
		 htole64(0xc1c93a376062db09ULL),
		 htole64(0xd3e20fe490359eb1ULL),
		 htole64(0xf2ea7514b1297b7bULL),
		 htole64(0x06f15e5f529c1f8bULL),
		 htole64(0x0a39fc286a3d8435ULL),
		 htole64(0xf574dcac2bce2fc7ULL)
	 } },
	{ {
		 htole64(0x220cbebc84e3d12eULL),
		 htole64(0x3453eaa193e837f1ULL),
		 htole64(0xd8b71333935203beULL),
		 htole64(0xa9d72c82ed03d675ULL),
		 htole64(0x9d721cad685e353fULL),
		 htole64(0x488e857e335c3c7dULL),
		 htole64(0xf948e1a05d71e4ddULL),
		 htole64(0xef1fdfb3e81566d2ULL)
	 } },
	{ {
		 htole64(0x601758fd7c6cfe57ULL),
		 htole64(0x7a56a27ea9ea63f5ULL),
		 htole64(0xdfff00b723271a16ULL),
		 htole64(0xbfcd1747253af5a3ULL),
		 htole64(0x359e35d7800fffbdULL),
		 htole64(0x7f151c1f1686104aULL),
		 htole64(0x9a3f410c6ca92363ULL),
		 htole64(0x4bea6bacad474799ULL)
	 } },
	{ {
		 htole64(0xfa68407a46647d6eULL),
		 htole64(0xbf71c57236904f35ULL),
		 htole64(0x0af21f66c2bec6b6ULL),
		 htole64(0xcffaa6b71c9ab7b4ULL),
		 htole64(0x187f9ab49af08ec6ULL),
		 htole64(0x2d66c4f95142a46cULL),
		 htole64(0x6fa4c33b7a3039c0ULL),
		 htole64(0xae4faeae1d3ad3d9ULL)
	 } },
	{ {
		 htole64(0x8886564d3a14d493ULL),
		 htole64(0x3517454ca23c4af3ULL),
		 htole64(0x06476983284a0504ULL),
		 htole64(0x0992abc52d822c37ULL),
		 htole64(0xd3473e33197a93c9ULL),
		 htole64(0x399ec6c7e6bf87c9ULL),
		 htole64(0x51ac86febf240954ULL),
		 htole64(0xf4c70e16eeaac5ecULL)
	 } },
	{ {
		 htole64(0xa47f0dd4bf02e71eULL),
		 htole64(0x36acc2355951a8d9ULL),
		 htole64(0x69d18d2bd1a5c42fULL),
		 htole64(0xf4892bcb929b0690ULL),
		 htole64(0x89b4443b4ddbc49aULL),
		 htole64(0x4eb7f8719c36de1eULL),
		 htole64(0x03e7aa020c6e4141ULL),
		 htole64(0x9b1f5b424d93c9a7ULL)
	 } },
	{ {
		 htole64(0x7261445183235adbULL),
		 htole64(0x0e38dc92cb1f2a60ULL),
		 htole64(0x7b2b8a9aa6079c54ULL),
		 htole64(0x800a440bdbb2ceb1ULL),
		 htole64(0x3cd955b7e00d0984ULL),
		 htole64(0x3a7d3a1b25894224ULL),
		 htole64(0x944c9ad8ec165fdeULL),
		 htole64(0x378f5a541631229bULL)
	 } },
	{ {
		 htole64(0x74b4c7fb98459cedULL),
		 htole64(0x3698fad1153bb6c3ULL),
		 htole64(0x7a1e6c303b7652f4ULL),
		 htole64(0x9fe76702af69334bULL),
		 htole64(0x1fffe18a1b336103ULL),
		 htole64(0x8941e71cff8a78dbULL),
		 htole64(0x382ae548b2e4f3f3ULL),
		 htole64(0xabbedea680056f52ULL)
	 } },
	{ {
		 htole64(0x6bcaa4cd81f32d1bULL),
		 htole64(0xdea2594ac06fd85dULL),
		 htole64(0xefbacd1d7d476e98ULL),
		 htole64(0x8a1d71efea48b9caULL),
		 htole64(0x2001802114846679ULL),
		 htole64(0xd8fa6bbbebab0761ULL),
		 htole64(0x3002c6cd635afe94ULL),
		 htole64(0x7bcd9ed0efc889fbULL)
	 } },
	{ {
		 htole64(0x48bc924af11bd720ULL),
		 htole64(0xfaf417d5d9b21b99ULL),
		 htole64(0xe71da4aa88e12852ULL),
		 htole64(0x5d80ef9d1891cc86ULL),
		 htole64(0xf82012d430219f9bULL),
		 htole64(0xcda43c32bcdf1d77ULL),
		 htole64(0xd21380b00449b17aULL),
		 htole64(0x378ee767f11631baULL)
	 } }
};
...
static void streebog_xor(const struct streebog_uint512 *x, const struct streebog_uint512 *y, struct streebog_uint512 *z)
{
...
static void streebog_xlps(const struct streebog_uint512 *x,	const struct streebog_uint512 *y, struct streebog_uint512 *data)
{
	uint64_t r0, r1, r2, r3, r4, r5, r6, r7;
	int i;

	r0 = letoh64(x->qword[0] ^ y->qword[0]);
	r1 = letoh64(x->qword[1] ^ y->qword[1]);
	r2 = letoh64(x->qword[2] ^ y->qword[2]);
	r3 = letoh64(x->qword[3] ^ y->qword[3]);
	r4 = letoh64(x->qword[4] ^ y->qword[4]);
	r5 = letoh64(x->qword[5] ^ y->qword[5]);
	r6 = letoh64(x->qword[6] ^ y->qword[6]);
	r7 = letoh64(x->qword[7] ^ y->qword[7]);

	for (i = 0; i <= 7; i++) {
		data->qword[i] = htole64(Ax[0][r0 & 0xFF]);
		data->qword[i] ^= htole64(Ax[1][r1 & 0xFF]);
		data->qword[i] ^= htole64(Ax[2][r2 & 0xFF]);
		data->qword[i] ^= htole64(Ax[3][r3 & 0xFF]);
		data->qword[i] ^= htole64(Ax[4][r4 & 0xFF]);
		data->qword[i] ^= htole64(Ax[5][r5 & 0xFF]);
		data->qword[i] ^= htole64(Ax[6][r6 & 0xFF]);
		data->qword[i] ^= htole64(Ax[7][r7 & 0xFF]);
		r0 >>= 8;
		r1 >>= 8;
		r2 >>= 8;
		r3 >>= 8;
...
static void streebog_round(int i, struct streebog_uint512 *Ki, struct streebog_uint512 *data)
{
	streebog_xlps(Ki, &C[i], Ki);
	streebog_xlps(Ki, data, data);
}

static void streebog_pad(StreebogContext *ctx)
{
	if (ctx->fillsize >= STREEBOG_BLOCK_SIZE)
		return;
	osMemset(ctx->buffer + ctx->fillsize, 0, sizeof(ctx->buffer) - ctx->fillsize);
	ctx->buffer[ctx->fillsize] = 1;
}

static void streebog_add512(const struct streebog_uint512 *x, const struct streebog_uint512 *y, struct streebog_uint512 *r)
{
	uint64_t carry = 0;
	int i;

	for (i = 0; i < 8; i++) {
		const uint64_t left = letoh64(x->qword[i]);
		uint64_t sum;

		sum = left + letoh64(y->qword[i]) + carry;
		if (sum != left)
			carry = (sum < left);
		r->qword[i] = htole64(sum);
	}
}

static void streebog_g(struct streebog_uint512 *h, const struct streebog_uint512 *N, const struct streebog_uint512 *m)
{
...
static void streebog_stage2(StreebogContext *ctx, const uint8_t *data)
{
	struct streebog_uint512 m;

	osMemcpy(&m, data, sizeof(m));
...
static void streebog_stage3(StreebogContext *ctx)
{
	struct streebog_uint512 buf = { { 0 } };

	buf.qword[0] = htole64(ctx->fillsize << 3);
	streebog_pad(ctx);
	...
	osMemcpy(&ctx->hash, &ctx->h, sizeof(struct streebog_uint512));
}

static void streebog_init(StreebogContext *ctx, size_t size)
{
	unsigned int i;

	osMemset(ctx, 0, sizeof(StreebogContext));
	if (size == STREEBOG256_DIGEST_SIZE)
		ctx->digest_size = STREEBOG256_DIGEST_SIZE;
	else
		ctx->digest_size = STREEBOG512_DIGEST_SIZE;
	for (i = 0; i < 8; i++) {
		if (ctx->digest_size == STREEBOG256_DIGEST_SIZE)
			ctx->h.qword[i] = htole64(0x0101010101010101ULL);
	}
}

static error_t streebog_compute(const void *data, size_t length, uint8_t *digest, size_t size)
{
#if (CRYPTO_STATIC_MEM_SUPPORT == DISABLED)
	StreebogContext *context;
#else
	StreebogContext context[1];
#endif
...
#if (CRYPTO_STATIC_MEM_SUPPORT == DISABLED)
	//Allocate a memory buffer to hold the Streebog-256 context
	context = cryptoAllocMem(sizeof(StreebogContext));
...
#if (STREEBOG256_SUPPORT == ENABLED)
	if (size == STREEBOG256_DIGEST_SIZE)
		//Initialize the Streebog-256 context
...
#endif
	//Digest the message
	streebogUpdate(context, data, length);
	//Finalize the Streebog-256 message digest
	streebogFinal(context, digest);
...
#if (STREEBOG256_SUPPORT == ENABLED)
/**
 * @brief Digest a message using Streebog-256
...
__weak_func error_t streebog256Compute(const void *data, size_t length, uint8_t *digest)
{
	return streebog_compute(data, length, digest, STREEBOG256_DIGEST_SIZE);
}
#endif
...
__weak_func error_t streebog512Compute(const void *data, size_t length, uint8_t *digest)
{
	return streebog_compute(data, length, digest, STREEBOG512_DIGEST_SIZE);
}
#endif


/**
 * @brief Initialize Streebog-256 message digest context
 * @param[in] ctx Pointer to the Sstreebog-256 context to initialize
 **/

__weak_func void streebog256Init(StreebogContext *ctx)
{
	streebog_init(ctx, STREEBOG256_DIGEST_SIZE);
}

/**
 * @brief Initialize Streebog-512 message digest context
 * @param[in] ctx Pointer to the Sstreebog-512 context to initialize
 **/

__weak_func void streebog512Init(StreebogContext *ctx)
{
	streebog_init(ctx, STREEBOG512_DIGEST_SIZE);
}


/**
 * @brief Update the Streebog-256 context with a portion of the message being hashed
 * @param[in] ctx Pointer to the Streebog-256 context
 * @param[in] buf Pointer to the buffer being hashed
 * @param[in] len Length of the buffer
 **/

__weak_func void streebogUpdate(StreebogContext *ctx, const void *buf, size_t len)
{
	size_t chunksize;
	...
	if (ctx->fillsize) {
		...
		if (chunksize > len)
			chunksize = len;
		osMemcpy(&ctx->buffer[ctx->fillsize], data, chunksize);
...
/**
 * @brief Finish the Streebog-256 message digest
 * @param[in] ctx Pointer to the Streebog-256 context
 * @param[out] digest Calculated digest (optional parameter)
 **/

__weak_func void streebogFinal(StreebogContext *ctx, uint8_t *digest)
{
	streebog_stage3(ctx);
	ctx->fillsize = 0;
	if (digest) {
		if (ctx->digest_size == STREEBOG256_DIGEST_SIZE)
			osMemcpy(digest, &ctx->hash.qword[4], STREEBOG256_DIGEST_SIZE);
		else
			osMemcpy(digest, &ctx->hash.qword[0], STREEBOG512_DIGEST_SIZE);
	}
}
