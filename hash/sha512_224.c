...
__weak error_t sha512_224Compute(const void *data, size_t length, uint8_t *digest)
{
   error_t error;
...
__weak void sha512_224Init(Sha512_224Context *context)
{
...
__weak void sha512_224Update(Sha512_224Context *context, const void *data, size_t length)
{
...
__weak void sha512_224Final(Sha512_224Context *context, uint8_t *digest)
{
   //The function is defined in the exact same manner as SHA-512
