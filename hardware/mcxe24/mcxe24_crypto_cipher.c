...
#include "hardware/mcxe24/mcxe24_crypto_cipher.h"
#include "cipher/cipher_algorithms.h"
#include "debug.h"

//Check crypto library configuration
#if (MCXE24_CRYPTO_CIPHER_SUPPORT == ENABLED && AES_SUPPORT == ENABLED)
   ...
   if(cipher == AES_CIPHER_ALGO)
   {
      ...
      else if((length % AES_BLOCK_SIZE) == 0)
      {
         ...
         if(aesContext->nr == 10)
         {
            ...
            osAcquireMutex(&mcxe24CryptoMutex);
            ...
            osReleaseMutex(&mcxe24CryptoMutex);
         }
         else
         {
