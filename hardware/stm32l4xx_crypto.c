...
#include "hardware/stm32l4xx_crypto.h"
#include "hardware/stm32l4xx_crypto_trng.h"
#include "hardware/stm32l4xx_crypto_hash.h"
#include "hardware/stm32l4xx_crypto_cipher.h"
#include "debug.h"
