...
#include "hardware/ra6_crypto_cipher.h"
...
void aesEncryptBlock(AesContext *context, const uint8_t *input, uint8_t *output)
{
   ...
   if(context->nr == 10)
   {
      ...
      HW_SCE_AES_128EcbEncrypt(context->ek, 4, (const uint32_t *) input,
         (uint32_t *) output);
   }
   else
   {
      //Perform AES-ECB encryption (256-bit key)
      HW_SCE_AES_256EcbEncrypt(context->ek, 4, (const uint32_t *) input,
         (uint32_t *) output);
   }
...
void aesDecryptBlock(AesContext *context, const uint8_t *input, uint8_t *output)
{
   ...
   if(context->nr == 10)
   {
      ...
      HW_SCE_AES_128EcbDecrypt(context->ek, 4, (const uint32_t *) input,
         (uint32_t *) output);
   }
   else
   {
      //Perform AES-ECB decryption (256-bit key)
      HW_SCE_AES_256EcbDecrypt(context->ek, 4, (const uint32_t *) input,
         (uint32_t *) output);
   }
