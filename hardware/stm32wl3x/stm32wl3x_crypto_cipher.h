/**
 * @file stm32wl3x_crypto_cipher.h
 * @brief STM32WL3 cipher hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32WL3X_CRYPTO_CIPHER_H
#define _STM32WL3X_CRYPTO_CIPHER_H

//Dependencies
#include "core/crypto.h"

//Cipher hardware accelerator
#ifndef STM32WL3X_CRYPTO_CIPHER_SUPPORT
   #define STM32WL3X_CRYPTO_CIPHER_SUPPORT DISABLED
#elif (STM32WL3X_CRYPTO_CIPHER_SUPPORT != ENABLED && STM32WL3X_CRYPTO_CIPHER_SUPPORT != DISABLED)
   #error STM32WL3X_CRYPTO_CIPHER_SUPPORT parameter is not valid
#endif
