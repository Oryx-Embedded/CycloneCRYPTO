...
#include "hardware/stm32f7xx_crypto.h"
#include "hardware/stm32f7xx_crypto_trng.h"
#include "hardware/stm32f7xx_crypto_hash.h"
#include "hardware/stm32f7xx_crypto_cipher.h"
#include "debug.h"
