/**
 * @file mcxn94_crypto_pkc.h
 * @brief NXP MCX N94 public-key hardware accelerator
 *
 * @section License
 *
...
#ifndef MCXN94_CRYPTO_PKC_SUPPORT
   #define MCXN94_CRYPTO_PKC_SUPPORT DISABLED
#elif (MCXN94_CRYPTO_PKC_SUPPORT != ENABLED && MCXN94_CRYPTO_PKC_SUPPORT != DISABLED)
   #error MCXN94_CRYPTO_PKC_SUPPORT parameter is not valid
#endif
