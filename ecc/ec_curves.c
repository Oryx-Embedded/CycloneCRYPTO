...
//tc26Sign512a OID (1.2.643.7.1.2.1.2.1)
const uint8_t TC26SIGN512A_OID[9] = {0x2A, 0x85, 0x03, 0x07, 0x01, 0x02, 0x01, 0x02, 0x01};
//tc26Sign512b OID (1.2.643.7.1.2.1.2.2)
const uint8_t TC26SIGN512B_OID[9] = {0x2A, 0x85, 0x03, 0x07, 0x01, 0x02, 0x01, 0x02, 0x02};
...
#endif
#if (TC26SIGN512A_SUPPORT == ENABLED)

/**
 * @brief tc26Sign512a elliptic curve
 * tc26Sign512a curves first recommended in 2013 and then standardized in
 * R 50.1.114-2016 and RFC 7836 for use with GOST R 34.10-2012 (as TC26
 * 512-bit ParamSetA).
 **/

const EcCurveInfo tc26Sign512aCurve =
{
	//Curve name
	"tc26Sign512a",
	//Object identifier
	TC26SIGN512A_OID,
	sizeof(TC26SIGN512A_OID),
	//Curve type
	EC_CURVE_TYPE_TC26SIGN512A,
	//Prime modulus p
	{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
#endif
#if (TC26SIGN512B_SUPPORT == ENABLED)
...
const EcCurveInfo tc26Sign512bCurve =
{
	//Curve name
	"tc26Sign512b",
	//Object identifier
	TC26SIGN512B_OID,
	sizeof(TC26SIGN512B_OID),
	//Curve type
	EC_CURVE_TYPE_TC26SIGN512B,
	//Prime modulus p
	...
	64,
	//Curve parameter b
	{0x68, 0x7D, 0x1B, 0x45, 0x9D, 0xC8, 0x41, 0x45, 0x7E, 0x3E, 0x06, 0xCF, 0x6F, 0x5E, 0x25, 0x17,
	 0xB9, 0x7C, 0x7D, 0x61, 0x4A, 0xF1, 0x38, 0xBC, 0xBF, 0x85, 0xDC, 0x80, 0x6C, 0x4B, 0x28, 0x9F,
	 0x3E, 0x96, 0x5D, 0x2D, 0xB1, 0x41, 0x6D, 0x21, 0x7F, 0x8B, 0x27, 0x6F, 0xAD, 0x1A, 0xB6, 0x9C,
	 0x50, 0xF7, 0x8B, 0xEE, 0x1F, 0xA3, 0x10, 0x6E, 0xFB, 0x8C, 0xCB, 0xC7, 0xC5, 0x14, 0x01, 0x16},
	64,
	//x-coordinate of the base point G
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    64,
	//y-coordinate of the base point G
	{0x1A, 0x8F, 0x7E, 0xDA, 0x38, 0x9B, 0x09, 0x4C, 0x2C, 0x07, 0x1E, 0x36, 0x47, 0xA8, 0x94, 0x0F,
	 0x3C, 0x12, 0x3B, 0x69, 0x75, 0x78, 0xC2, 0x13, 0xBE, 0x6D, 0xD9, 0xE6, 0xC8, 0xEC, 0x73, 0x35,
	 0xDC, 0xB2, 0x28, 0xFD, 0x1E, 0xDF, 0x4A, 0x39, 0x15, 0x2C, 0xBC, 0xAA, 0xF8, 0xC0, 0x39, 0x88,
	 0x28, 0x04, 0x10, 0x55, 0xF9, 0x4C, 0xEE, 0xEC, 0x7E, 0x21, 0x34, 0x07, 0x80, 0xFE, 0x41, 0xBD},	64,	//Base point order q
	{0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
	 0x49, 0xA1, 0xEC, 0x14, 0x25, 0x65, 0xA5, 0x45, 0xAC, 0xFD, 0xB7, 0x7B, 0xD9, 0xD4, 0x0C, 0xFA,
	 0x8B, 0x99, 0x67, 0x12, 0x10, 0x1B, 0xEA, 0x0E, 0xC6, 0x34, 0x6C, 0x54, 0x37, 0x4F, 0x25, 0xBD},
	64,
	//Cofactor
	1,
	//Fast modular reduction
...
#endif
#if (TC26SIGN512A_SUPPORT == ENABLED)
   //tc26Sign512a elliptic curve?
   else if (!oidComp(oid, length, TC26SIGN512A_OID, sizeof(TC26SIGN512A_OID)))
   {
      curveInfo = TC26SIGN512A_CURVE;
   }
#endif
#if (TC26SIGN512B_SUPPORT == ENABLED)
   //tc26Sign512b elliptic curve?
   else if (!oidComp(oid, length, TC26SIGN512B_OID, sizeof(TC26SIGN512B_OID)))
   {
      curveInfo = TC26SIGN512B_CURVE;
   }
#endif
   //Unknown identifier?
   else
